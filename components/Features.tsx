  ...
  return (
    ...
    >
      <Reveal>
        ...
        <h2 className="max-w-2xl text-3xl font-black tracking-tight text-[var(--color-ink)] sm:text-5xl">
      ...
      <div className="mt-14 grid grid-cols-1 gap-6 md:grid-cols-3">
        {features.map((f, i) => (
          <Reveal key={f.title} delay={i * 0.1}>
            <div className="group h-full rounded-2xl border border-[var(--color-line)] bg-[var(--color-surface)] p-7 shadow-[var(--shadow-card)] transition-all duration-300 hover:-translate-y-1 hover:border-[var(--color-orange)]/40 hover:shadow-[var(--shadow-lift)]">
              <div className="mb-5 flex h-12 w-12 items-center justify-center rounded-xl bg-[var(--color-orange-tint)] text-[var(--color-orange)] ring-1 ring-[var(--color-orange)]/15">
